function [ Tau ] = Double_cloison_Tau_syms_AM_MatTra(h1,h2,E1,E2,f,k,theta,rho1,rho2,nu1,nu2,e,ef,kf,kff,Zf,Zff,Zc1,Zc2,eta)
...
kx = kff.*cos(thetaf);
Tff = [cos(kx*ef) 1j.*Zf./cos(thetaf).*sin(kx.*ef); 1j.*cos(thetaf)./Zff.*sin(kx.*ef) cos(kx*ef) ];
